...
function Dashboard() {
    ...
    useEffect(() => {
        ...
        const fetchConversations = async () => {
            const res = await fetch(`https://chat-wave-z2f9.onrender.com/api/conversations/${loggedInUser?.id}`, {
                method: 'GET',
                headers: {
    ...
    useEffect(() => {
        async function fetchUsers() {
            const res = await fetch(`https://chat-wave-z2f9.onrender.com/api/users/${user?.id}`, {
                method: 'GET',
                headers: {
                'Content-Type': 'application/json',
            },
    ...
    async function fetchMessages(conversationId, receiver) {
        const res = await fetch(`https://chat-wave-z2f9.onrender.com/api/message/${conversationId}?senderId=${user?.id}&&receiverId=${receiver?.receiverId}`, {
            method: 'GET',
            headers: {
                'Content-Type': 'application/json',
            },
    ...
    async function sendMessage(e) {
        ...
        await fetch(`https://chat-wave-z2f9.onrender.com/api/message`, {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
            },
